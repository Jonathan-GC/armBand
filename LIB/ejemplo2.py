...
Servo2 = Servo.Servo(33)
Servo3 = Servo.Servo(35) 
        ...
        while True:
            ...
            if r != last_r:
                ...
                if r == 1:
                    ...
                    Servo2.writeServo(50)
                    Servo3.writeServo(50)
                elif r == 0:
                    Servo1.writeServo(180)
                    Servo2.writeServo(180)
                    Servo3.writeServo(180)
                elif r == 2:
                    Servo1.writeServo(0)
                    Servo2.writeServo(0)
                    Servo3.writeServo(0)
                    ...
                    Servo2.writeServo(20)
                    Servo3.writeServo(20)
                elif r == 4:
                    Servo1.writeServo(100)
                    Servo2.writeServo(100)
